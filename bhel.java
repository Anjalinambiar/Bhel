<!DOCTYPE html>
<!-- saved from url=(0028)https://notepad.pw/ummimau12 -->
<html ng-app="app" lang="en" class="ng-scope"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}.ng-animate-shim{visibility:hidden;}.ng-anchor{position:absolute;}</style>
    ...
    <link rel="shortcut icon" href="https://notepad.pw/favicon.ico" type="image/x-icon">
    <link rel="icon" href="https://notepad.pw/favicon.ico" type="image/x-icon">
    ...
    <title>notepad.pw / ummimau12 | The napkin of the internet.</title>
    <link href="./bhel_files/css" rel="stylesheet" type="text/css">
    <link id="mode" href="./bhel_files/global.css" rel="stylesheet" type="text/css">
    <link href="./bhel_files/normalize.min.css" rel="stylesheet" media="screen" type="text/css">
    <link href="./bhel_files/ionicons.min.css" rel="stylesheet" type="text/css">
    <style>
        .adsense {
            display:none;
            width:90%;
    ...
    <script src="./bhel_files/amp4ads-host-v0.js.download"></script><script src="./bhel_files/134240187179576" async=""></script><script async="" src="./bhel_files/fbevents.js.download"></script><script src="./bhel_files/pubads_impl_rendering_2020012701.js.download"></script><script src="./bhel_files/rules-p-UeXruRVtZz7w6.js.download" async=""></script><script async="" type="text/javascript" src="./bhel_files/beacon.js.download"></script><script async="" type="text/javascript" src="./bhel_files/bxl.js.download"></script><script async="" type="text/javascript" src="./bhel_files/quant.js.download"></script><script type="text/javascript" async="" src="./bhel_files/analytics.js.download"></script><script async="" type="text/javascript" src="./bhel_files/prebid-analytics-3.4.0.js.download"></script><script async="" type="text/javascript" src="./bhel_files/gpt.js.download"></script><script async="" src="./bhel_files/pubfig.min.js.download"></script><script data-cfasync="false" type="text/javascript">
...
</style><link rel="preload" href="./bhel_files/f.txt" as="script"><script type="text/javascript" src="./bhel_files/f.txt"></script><link rel="preload" href="./bhel_files/f(1).txt" as="script"><script type="text/javascript" src="./bhel_files/f(1).txt"></script><script src="./bhel_files/pubads_impl_2020012701.js.download" async=""></script><style></style><link rel="prefetch" href="https://tpc.googlesyndication.com/safeframe/1-0-37/html/container.html"></head>

<body style="visibility: visible; padding-bottom: 2px;"><iframe marginwidth="0" marginheight="0" scrolling="no" frameborder="0" height="0" width="0" id="_mN_cksync_0" src="./bhel_files/checksync.html" style="display: none !important;"></iframe><div class="wpcc-container wpcc-banner wpcc-corners-round wpcc-corners-small wpcc-border-thin wpcc-bottom wpcc-color-custom--943834009 " style=""><span class="wpcc-message">This website uses cookies to ensure you get the best experience on our website. <a class="wpcc-privacy" href="https://www.internetcookies.org/" rel="noopener" target="_blank" tabindex="1">Learn more</a></span><div class="wpcc-compliance"><a class="wpcc-btn" tabindex="2">Got it!</a></div></div>
    ...
    <div ng-controller="app.navigation" class="functions ng-scope">
        <div class="nav">
            ...
            <div class="fl-right" style="opacity: 0.7;">
                ...
                <a class="desktop-only tooltip " href="https://notepad.pw/account/login">
                    <i class="ion-person"></i>
                    <div class="tooltiptext">Account Panel</div>
                </a>
                <a href="javascript:void(0)" class="desktop-only tooltip not-active" ng-click="sp()">
                    SP
                    <div class="tooltiptext">Spell Check</div>
                </a>
                <a href="javascript:void(0)" ng-init="mo_class = &#39;not-active&#39;" class="desktop-only tooltip not-active" ng-click="mo()">
                    MO
            ...
            <div class="cf"></div>
            <div ng-show="modal" class="modal ng-hide" style="opacity: 1; display: block;">
                <!-- ngIf: edit_password -->
                <!-- ngIf: change_url -->
                <!-- ngIf: password_options -->
            </div>
        </div>
    </div>
    <div class="txt-holder ng-scope" ng-controller="app.push">
        <textarea ng-model="textarea" allow-tab="" open-url="" character-count="" bind-input="update_contents();" ng-change="update_contents();" class="textarea ng-valid ng-touched ng-not-empty ng-dirty ng-valid-parse" spellcheck="false" placeholder="" style="font-size: 15px; height: 396.8px;"></textarea>
        <div style="-webkit-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select: none;" class="direct-raw desktop-only">
            ...
            <a target="_blank" href="https://notepad.pw/raw/6uk2eix10" title="View in plain-text">Raw</a>&nbsp;
            <a target="_blank" href="https://notepad.pw/markdown/6uk2eix10" title="View in markdown">MarkDown</a>&nbsp;
            <a target="_blank" href="https://notepad.pw/code/6uk2eix10" title="View with line numbers">Code</a>&nbsp;
        </div>
    </div>
    <div ng-controller="app.navigation" class="functions ng-scope">
        <div class="footer-share text-center" style="opacity: 0.7;">
            <button class="share-btn" title="Copy Editable Link" data-clipboard-text="https://notepad.pw/ummimau12" onclick="$(this).find(&#39;span&#39;).stop().fadeOut().fadeIn();"><span><i class="ion-link"></i> Editable Link</span></button>
            <button class="share-btn" title="Copy Share Link" data-clipboard-text="https://notepad.pw/share/6uk2eix10" onclick="$(this).find(&#39;span&#39;).stop().fadeOut().fadeIn();"><span><i class="ion-android-share"></i> Share Link</span></button>
            <div class="footer-stats"><b>Words:</b> <span class="word_count">33</span> | <b>Chars:</b> <span class="char_count">342</span> </div>
                    </div>
    </div>
</div>

<div class="footer-print" style="margin-bottom: 40px; display: block;">
    <a target="_blank" href="https://notepad.pw/privacy">Privacy</a>
    ...
    <i class="ion-ios-minus-empty"></i>
    <a target="_blank" href="https://notepad.pw/contact">Contact Us</a>
    <i class="ion-ios-minus-empty"></i>
...
<div class="np-share desktop-only">
    <div class="share-content">
        <a class="share-link" href="https://www.facebook.com/sharer/sharer.php?u=https://notepad.pw/share/6uk2eix10" onclick="javascript:window.open(this.href, &#39;&#39;, &#39;menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600&#39;);return false;" target="_blank"><i class="ion-social-facebook"></i></a>
        <a class="share-link" href="http://twitter.com/share?text=notepad.pw&amp;url=https://notepad.pw/share/6uk2eix10" onclick="javascript:window.open(this.href, &#39;&#39;, &#39;menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600&#39;);return false;" target="_blank"><i class="ion-social-twitter"></i></a>
        <a class="share-link" href="https://reddit.com/submit?url=https://notepad.pw/share/6uk2eix10&amp;title=notepad.pw" target="_blank"><i class="ion-social-reddit"></i></a>
    </div>
    <i class="ion-ios-upload-outline share-opener" style="width: 20px;display: block;"></i>
</div>

<script type="text/javascript" src="./bhel_files/jquery.min.js.download"></script>
<script type="text/javascript" src="./bhel_files/angular.min.js.download"></script>
<div style="position: absolute; height: 0px; width: 0px; top: -5000px; left: -5000px;"><div id="AdFrame1" style="position: absolute; left: -5000px; top: -5000px; height: 60px; width: 468px;"></div></div><script type="text/javascript" src="./bhel_files/angular-cookies.min.js.download"></script>
<script type="text/javascript" src="./bhel_files/socket.io.min.js.download"></script>
<script>
    note_created = false;
    password_set = false;
    caret = 0;
...
<script type="text/javascript" src="./bhel_files/app.min.js.download"></script>
<script type="text/javascript" src="./bhel_files/store.min.js.download"></script>
<script src="./bhel_files/clipboard.min.js.download"></script>
<link rel="stylesheet" type="text/css" href="./bhel_files/cookieconsent.min.css"><script src="./bhel_files/cookieconsent.min.js.download"></script><script>window.addEventListener("load", function(){window.wpcc.init({"border":"thin","corners":"small","colors":{"popup":{"background":"#f6f6f6","text":"#000000","border":"#555555"},"button":{"background":"#555555","text":"#ffffff"}},"position":"bottom"})});</script>
<script async="" src="./bhel_files/js"></script>
<script>
...
<div id="sticky-footer" class="sticky-footer-standard" style="background-color: rgba(255, 255, 255, 1) !important;"><div id="slot-footer-wrapper" class="sticky-wrapper"><div id="notepad_970x90_728x90_320x50_Sticky" name="notepad_970x90_728x90_320x50_Sticky" data-google-query-id="CNy_oqrssucCFXeLSwUdu64PgQ"><div id="google_ads_iframe_/15184186/notepad_970x90_728x90_320x50_Sticky_0__container__" style="border: 0pt none;"><iframe id="google_ads_iframe_/15184186/notepad_970x90_728x90_320x50_Sticky_0" title="3rd party ad content" name="google_ads_iframe_/15184186/notepad_970x90_728x90_320x50_Sticky_0" width="970" height="90" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" style="border: 0px; vertical-align: bottom;" data-google-container-id="4" data-load-complete="true" src="./bhel_files/saved_resource(2).html"></iframe></div></div><button class="fs-close-button"></button></div></div><div id="banner_ad" style="position: absolute; left: -5000px; top: -5000px;"></div></body><iframe sandbox="allow-scripts allow-same-origin" id="604554adbb1417f" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" width="0" hspace="0" vspace="0" height="0" style="height:0px;width:0px;display:none;" scrolling="no" src="./bhel_files/async_usersync.html">
    </iframe><iframe sandbox="allow-scripts allow-same-origin" id="61bea9e2bbae109" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" width="0" hspace="0" vspace="0" height="0" style="height:0px;width:0px;display:none;" scrolling="no" src="./bhel_files/index.html">
    </iframe><iframe sandbox="allow-scripts allow-same-origin" id="625241f9537997" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" width="0" hspace="0" vspace="0" height="0" style="height:0px;width:0px;display:none;" scrolling="no" src="./bhel_files/async_usersync(1).html">
    </iframe><iframe sandbox="allow-scripts allow-same-origin" id="6354cd73704a3df" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" width="0" hspace="0" vspace="0" height="0" style="height:0px;width:0px;display:none;" scrolling="no" src="./bhel_files/usync.html">
    </iframe><iframe sandbox="allow-scripts allow-same-origin" id="643c462e75954e" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" width="0" hspace="0" vspace="0" height="0" style="height:0px;width:0px;display:none;" scrolling="no" src="./bhel_files/index(1).html">
    </iframe><iframe sandbox="allow-scripts allow-same-origin" id="6539d1c6a2b55fd" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" width="0" hspace="0" vspace="0" height="0" style="height:0px;width:0px;display:none;" scrolling="no" src="./bhel_files/index(2).html">
    </iframe><iframe sandbox="allow-scripts allow-same-origin" id="6646ce1e86b3e92" frameborder="0" allowtransparency="true" marginheight="0" marginwidth="0" width="0" hspace="0" vspace="0" height="0" style="height:0px;width:0px;display:none;" scrolling="no" src="./bhel_files/async_usersync(2).html">
    </iframe></html>